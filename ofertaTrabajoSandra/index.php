        ...
        if ($_FILES['photo']['error'] != UPLOAD_ERR_OK) {
            switch ($_FILES['photo']['error']) {
                ...
                case UPLOAD_ERR_FORM_SIZE:
                    $errors['size'] = 'El archivo se excede en tamaño.';
                    break;
                case UPLOAD_ERR_PARTIAL:
                    $errors['partial'] = 'Solo se ha podido subir parte del archivo, inténtalo de nuevo';
                    break;
                case UPLOAD_ERR_NO_FILE:
                    $errors['noFile'] = 'No se ha podido subir el archivo.';
                    break;
                default:
                    $errors['undefined'] = 'Error indeterminado';
            }
...
<body>
    ...
    ?>
        ...
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            Foto: (.png) <input type="file" name="photo"><br>
